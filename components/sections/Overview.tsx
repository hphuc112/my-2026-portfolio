...
export function Overview() {
  return (
    ...
    >
      <Reveal>
        <div className="border-border/60 bg-accent grid gap-8 rounded-3xl border p-8 shadow-sm lg:grid-cols-[0.9fr_1.1fr] lg:p-10">
          ...
          <div className="text-foreground/70 flex flex-col gap-4 text-base leading-7">
            ...
            <p>
              ...
              experienced engineers. I enjoy the problem-solving side of
              front-end work as much as the design side turning a Figma file
              into pixel-accurate, functional UI is what I find most satisfying.
              I&apos;m also comfortable reading and writing technical English,
              and currently exploring component design systems in more depth.
            </p>
          </div>
        </div>
      </Reveal>
